...
public class TestEmployee {
    public static void main(String args[]){
        ...
        Employee gerardo = model.createEmployee("Gerardo", "Rodriguez", 27, 30, 40, EmployeeType.MANAGER, true);
        Employee juan = model.createEmployee("Juan", "Alvarez", 18, 20, 40, EmployeeType.CHEF, false);
